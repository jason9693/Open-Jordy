...
|---|---|---|
| `OPENJORDY_COMBINE_W_RL` | `1.0` | Weight $w_{\text{binary}}$ for the GRPO advantage |
| `OPENJORDY_COMBINE_W_OPD` | `1.0` | Weight $w_{\text{opd}}$ for the teacher advantage |
...
openjordy-combine/
├── README.md
├── run_qwen3_4b_openjordy_combine.sh   # Launch script
├── openjordy_combine_api_server.py     # Async proxy: hint judge + PRM eval + sample submission
├── openjordy_combine_rollout.py        # Rollout bridge to SLIME trainer

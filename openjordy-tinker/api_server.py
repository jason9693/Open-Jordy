"""FastAPI proxy for OpenJordy training data collection via Tinker.

Contains a shared base class and three method-specific subclasses:
  - OpenJordyRLServer:      Binary RL with PRM scoring
  - OpenJordyOPDServer:     On-Policy Distillation (hint judge + teacher logprobs)
  - OpenJordyCombineServer: Combined OPD + RL with three-way dispatch
...
class _BaseServer:
    """Shared infrastructure for all three OpenJordy Tinker proxy servers."""

    _TITLE = "OpenJordy Tinker Proxy"
...
class OpenJordyRLServer(_BaseServer):
    """Proxy for Binary RL training with PRM scoring."""

    _TITLE = "OpenJordy-RL Tinker Proxy"
...
class OpenJordyOPDServer(_BaseServer):
    """Proxy for On-Policy Distillation (OPD) training."""

    _TITLE = "OpenJordy-OPD Tinker Proxy"
...
class OpenJordyCombineServer(_BaseServer):
    ...
    _TITLE = "OpenJordy-Combine Tinker Proxy"

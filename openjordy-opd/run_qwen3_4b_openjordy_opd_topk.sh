...
SAVE_CKPT=${SAVE_CKPT:-/absolute/path/to/OpenJordy-RL/ckpt/qwen3-4b-openjordy-opd-topk}
...
export OPENJORDY_OPD_TEACHER_LP_MAX_CONCURRENCY="${OPENJORDY_OPD_TEACHER_LP_MAX_CONCURRENCY:-3}"

...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "openjordy-control-ui",
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as OpenJordyApp);
      void loadAgents(host as unknown as OpenJordyApp);
      void loadToolsCatalog(host as unknown as OpenJordyApp);
      void loadNodes(host as unknown as OpenJordyApp, { quiet: true });
      void loadDevices(host as unknown as OpenJordyApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (state === "final") {
    void loadSessions(host as unknown as OpenJordyApp, {
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as OpenJordyApp, payload);
  handleTerminalChatEvent(host, payload, state);
  if (state === "final" && shouldReloadHistoryForFinalEvent(payload)) {
    void loadChatHistory(host as unknown as OpenJordyApp);
  }
}

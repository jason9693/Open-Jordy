...
import { type OpenJordyConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenJordyConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenJordyConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenJordyConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenJordyConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpenJordyConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OpenJordyConfig): GatewaySessionsDefaults {

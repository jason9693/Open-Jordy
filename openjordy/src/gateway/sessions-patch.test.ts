...
const EMPTY_CFG = {} as OpenJordyConfig;
...
async function applySubagentModelPatch(cfg: OpenJordyConfig) {
...
function createAllowlistedAnthropicModelCfg(): OpenJordyConfig {
  return {
    agents: {
      defaults: {

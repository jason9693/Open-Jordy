...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/openjordy/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openjordy/extensions",
        global: "/Users/x/.openjordy/extensions",
        workspace: "/Users/x/ws/.openjordy/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.openjordy/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openjordy/extensions",
        global: "/Users/x/.openjordy/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.openjordy/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openjordy/extensions",
        global: "/Users/x/.openjordy/extensions",

...
export const PLUGIN_MANIFEST_FILENAME = "openjordy.plugin.json";
...
// package.json "openjordy" metadata (used for onboarding/catalog)
...
export type OpenJordyPackageManifest = {
  extensions?: string[];
...
): OpenJordyPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }

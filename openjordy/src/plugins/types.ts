...
export type OpenJordyPluginConfigSchema = {
...
export type OpenJordyPluginToolContext = {
...
export type OpenJordyPluginToolFactory = (
  ctx: OpenJordyPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type OpenJordyPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type OpenJordyPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<OpenJordyConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type OpenJordyPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current OpenJordy configuration */
  config: OpenJordyConfig;
 ...
 */
export type OpenJordyPluginCommandDefinition = {
...
export type OpenJordyPluginHttpRouteAuth = "gateway" | "plugin";
export type OpenJordyPluginHttpRouteMatch = "exact" | "prefix";

export type OpenJordyPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type OpenJordyPluginHttpRouteParams = {
  path: string;
  handler: OpenJordyPluginHttpRouteHandler;
  auth: OpenJordyPluginHttpRouteAuth;
  match?: OpenJordyPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type OpenJordyPluginCliContext = {
  program: Command;
  config: OpenJordyConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type OpenJordyPluginCliRegistrar = (ctx: OpenJordyPluginCliContext) => void | Promise<void>;

export type OpenJordyPluginServiceContext = {
  config: OpenJordyConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type OpenJordyPluginService = {
  id: string;
  start: (ctx: OpenJordyPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: OpenJordyPluginServiceContext) => void | Promise<void>;
};

export type OpenJordyPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type OpenJordyPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: OpenJordyPluginConfigSchema;
  register?: (api: OpenJordyPluginApi) => void | Promise<void>;
  activate?: (api: OpenJordyPluginApi) => void | Promise<void>;
};

export type OpenJordyPluginModule =
  | OpenJordyPluginDefinition
  | ((api: OpenJordyPluginApi) => void | Promise<void>);

export type OpenJordyPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | OpenJordyPluginToolFactory,
    opts?: OpenJordyPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: OpenJordyPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: OpenJordyPluginHttpRouteParams) => void;
  registerChannel: (registration: OpenJordyPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: OpenJordyPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: OpenJordyPluginService) => void;
   ...
   */
  registerCommand: (command: OpenJordyPluginCommandDefinition) => void;

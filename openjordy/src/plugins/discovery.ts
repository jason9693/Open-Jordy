...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @openjordy/voice-call -> voice-call).
...
export function discoverOpenJordyPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".openjordy", "extensions")];

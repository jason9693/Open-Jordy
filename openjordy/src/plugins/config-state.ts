...
export const normalizePluginsConfig = (
  config?: OpenJordyConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: OpenJordyConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: OpenJordyConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: OpenJordyConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }

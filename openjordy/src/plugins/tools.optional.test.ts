...
const loadOpenJordyPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadOpenJordyPlugins: (params: unknown) => loadOpenJordyPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadOpenJordyPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadOpenJordyPluginsMock.mockClear();
  });

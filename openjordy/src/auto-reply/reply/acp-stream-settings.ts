...
function resolveAcpStreamCoalesceIdleMs(cfg: OpenJordyConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OpenJordyConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OpenJordyConfig): AcpProjectionSettings {

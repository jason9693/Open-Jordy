...
function resolveMentionPatterns(cfg: OpenJordyConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenJordyConfig | undefined, agentId?: string): RegExp[] {

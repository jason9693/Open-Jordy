...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bopenjordy\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: {
          identityName: "OpenJordy",
          provider: "anthropic",
          model: "claude-opus-4-5",
          thinkingLevel: "high",
        },
        expected: "[OpenJordy] anthropic/claude-opus-4-5 (think:high)",
      },
    ] as const;

...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openjordy", { botUsername: "openjordy" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openjordy args", {
        botUsername: "openjordy",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@openjordy: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openjordy" })).toBe(
      "/help@otherbot",
    );
  });

...
export const A2UI_PATH = "/__openjordy__/a2ui";

export const CANVAS_HOST_PATH = "/__openjordy__/canvas";

export const CANVAS_WS_PATH = "/__openjordy__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openjordyCanvasA2UIAction.postMessage(...)
  // - Android: window.openjordyCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openjordyCanvasA2UIAction"];
  ...
  globalThis.OpenJordy = globalThis.OpenJordy ?? {};
  globalThis.OpenJordy.postMessage = postToNode;
  globalThis.OpenJordy.sendUserAction = sendUserAction;
  globalThis.openjordyPostMessage = postToNode;
  globalThis.openjordySendUserAction = sendUserAction;

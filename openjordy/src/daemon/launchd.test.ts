...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.openjordy.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", OPENJORDY_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.openjordy.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.openjordy.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when OPENJORDY_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.openjordy.gateway.plist",
    },
    {
      name: "uses profile-specific label when OPENJORDY_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", OPENJORDY_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.openjordy.jbphoenix.plist",
    },
    {
      name: "prefers OPENJORDY_LAUNCHD_LABEL over OPENJORDY_PROFILE",
      env: {
        HOME: "/Users/test",
        OPENJORDY_PROFILE: "jbphoenix",
        OPENJORDY_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from OPENJORDY_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        OPENJORDY_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty OPENJORDY_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        OPENJORDY_PROFILE: "myprofile",
        OPENJORDY_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.openjordy.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {

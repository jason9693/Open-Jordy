...
let originalOpenJordyTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalOpenJordyTestConsole = process.env.OPENJORDY_TEST_CONSOLE;
  process.env.OPENJORDY_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalOpenJordyTestConsole === undefined) {
    delete process.env.OPENJORDY_TEST_CONSOLE;
  } else {
    process.env.OPENJORDY_TEST_CONSOLE = originalOpenJordyTestConsole;
  }

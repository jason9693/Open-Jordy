...
function resolveAnthropicDefaultAuthMode(cfg: OpenJordyConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenJordyConfig): OpenJordyConfig {
...
export function applyTalkApiKey(config: OpenJordyConfig): OpenJordyConfig {
...
export function applyTalkConfigNormalization(config: OpenJordyConfig): OpenJordyConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: OpenJordyConfig): OpenJordyConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenJordyConfig): OpenJordyConfig {
...
export function applyLoggingDefaults(cfg: OpenJordyConfig): OpenJordyConfig {
...
export function applyContextPruningDefaults(cfg: OpenJordyConfig): OpenJordyConfig {
...
export function applyCompactionDefaults(cfg: OpenJordyConfig): OpenJordyConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }

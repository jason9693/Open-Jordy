...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPENJORDY_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: OpenJordyConfig): string[] {
...
export function listTelegramAccountIds(cfg: OpenJordyConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpenJordyConfig): string {
...
function mergeTelegramAccountConfig(cfg: OpenJordyConfig, accountId: string): TelegramAccountConfig {
  const {
    accounts: _ignored,
  ...
  // See: https://github.com/openjordy/openjordy/issues/30673
...
export function listEnabledTelegramAccounts(cfg: OpenJordyConfig): ResolvedTelegramAccount[] {

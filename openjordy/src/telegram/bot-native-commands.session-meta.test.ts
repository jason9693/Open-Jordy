...
function registerAndResolveStatusHandler(cfg: OpenJordyConfig): TelegramCommandHandler {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/openjordy-sessions.json");

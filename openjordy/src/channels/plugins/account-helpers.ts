...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: OpenJordyConfig): string | undefined {
  ...
  function listAccountIds(cfg: OpenJordyConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: OpenJordyConfig): string {

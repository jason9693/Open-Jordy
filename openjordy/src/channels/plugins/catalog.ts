...
import { discoverOpenJordyPlugins } from "../../plugins/discovery.js";
import type { OpenJordyPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, OpenJordyPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["OPENJORDY_PLUGIN_CATALOG_PATHS", "OPENJORDY_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<OpenJordyPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: OpenJordyPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: OpenJordyPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverOpenJordyPlugins({ workspaceDir: options.workspaceDir });

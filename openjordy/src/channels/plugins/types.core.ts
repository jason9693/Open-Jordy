...
export type ChannelAgentToolFactory = (params: { cfg?: OpenJordyConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenJordyConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenJordyConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenJordyConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenJordyConfig }) => boolean;

...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: OpenJordyConfig, accountId?: string | null) => ResolvedAccount;
  defaultAccountId?: (cfg: OpenJordyConfig) => string;
  setAccountEnabled?: (params: {
    cfg: OpenJordyConfig;
    accountId: string;
    enabled: boolean;
  }) => OpenJordyConfig;
  deleteAccount?: (params: { cfg: OpenJordyConfig; accountId: string }) => OpenJordyConfig;
  isEnabled?: (account: ResolvedAccount, cfg: OpenJordyConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: OpenJordyConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: OpenJordyConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: OpenJordyConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: OpenJordyConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.openjordy.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: OpenJordyConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};

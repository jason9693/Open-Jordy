...
export function listChannelMessageActions(cfg: OpenJordyConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OpenJordyConfig): boolean {
...
export function supportsChannelMessageCards(cfg: OpenJordyConfig): boolean {

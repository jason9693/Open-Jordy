...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: OpenJordyConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: OpenJordyConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: OpenJordyConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: OpenJordyConfig }): Promise<void> {

...
export function isAcpEnabledByPolicy(cfg: OpenJordyConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: OpenJordyConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: OpenJordyConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: OpenJordyConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: OpenJordyConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: OpenJordyConfig, agentId: string): boolean {

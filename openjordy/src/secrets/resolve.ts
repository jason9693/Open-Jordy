...
function resolveResolutionLimits(config: OpenJordyConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OpenJordyConfig): SecretProviderConfig {

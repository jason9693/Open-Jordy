...
export function applyVercelAiGatewayProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
...
export function applyVercelAiGatewayConfig(cfg: OpenJordyConfig): OpenJordyConfig {

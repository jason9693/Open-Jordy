...
const ensureOpenJordyModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveOpenJordyAgentDir = vi.fn().mockReturnValue("/tmp/openjordy-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/openjordy-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureOpenJordyModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveOpenJordyAgentDir,
}));

...
export function applyOpenrouterProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OpenJordyConfig): OpenJordyConfig {
...
export function applyMoonshotConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: OpenJordyConfig): OpenJordyConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenJordyConfig): OpenJordyConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenJordyConfig): OpenJordyConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: OpenJordyConfig): OpenJordyConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: OpenJordyConfig): OpenJordyConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: OpenJordyConfig): OpenJordyConfig {
...
export function applyQianfanProviderConfig(cfg: OpenJordyConfig): OpenJordyConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpenJordyConfig): OpenJordyConfig {

...
function resolveDefaultAccountId(cfg: OpenJordyConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenJordyConfig): boolean {
...
export function summarizeBindings(cfg: OpenJordyConfig, bindings: AgentBinding[]): string[] {

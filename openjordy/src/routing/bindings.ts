...
export function listBindings(cfg: OpenJordyConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: OpenJordyConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenJordyConfig) {

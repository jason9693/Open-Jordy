...
type WebSearchConfig = NonNullable<OpenJordyConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: OpenJordyConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("openjordy configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.openjordy.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://openjordy.ai",
          "X-Title": "OpenJordy Web Search",
        },

...
function asOpenJordyConfig(config: Partial<OpenJordyConfig>): OpenJordyConfig {
  return config as OpenJordyConfig;
}

function createToolConfig() {
  return asOpenJordyConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: OpenJordyConfig = createToolConfig()) {

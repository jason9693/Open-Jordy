...
function resolveMemoryToolContext(options: { config?: OpenJordyConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: OpenJordyConfig): MemoryCitationsMode {

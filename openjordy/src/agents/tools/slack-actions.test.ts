...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): OpenJordyConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: OpenJordyConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: OpenJordyConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();

...
export const DEFAULT_SANDBOX_IMAGE = "openjordy-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openjordy-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openjordy-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openjordy-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openjordy-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "openjordy-sandbox-browser";

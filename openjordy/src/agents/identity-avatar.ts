...
function resolveAvatarSource(cfg: OpenJordyConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenJordyConfig, agentId: string): AgentAvatarResolution {

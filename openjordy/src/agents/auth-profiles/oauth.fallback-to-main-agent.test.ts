...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenJordyAgentDir() returns mainAgentDir
    process.env.OPENJORDY_STATE_DIR = tmpDir;
    process.env.OPENJORDY_AGENT_DIR = mainAgentDir;

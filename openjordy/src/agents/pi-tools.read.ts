...
function resolveAdaptiveReadMaxBytes(options?: OpenJordyReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOpenJordyReadTool(base, {
...
export function createOpenJordyReadTool(
  base: AnyAgentTool,
  options?: OpenJordyReadToolOptions,
): AnyAgentTool {

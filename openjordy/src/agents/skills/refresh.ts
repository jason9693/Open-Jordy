...
function resolveWatchPaths(workspaceDir: string, config?: OpenJordyConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpenJordyConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenJordyConfig }) {

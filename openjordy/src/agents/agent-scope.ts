...
type AgentEntry = NonNullable<NonNullable<OpenJordyConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: OpenJordyConfig): AgentEntry[] {
...
export function listAgentIds(cfg: OpenJordyConfig): string[] {
...
export function resolveDefaultAgentId(cfg: OpenJordyConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: OpenJordyConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: OpenJordyConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: OpenJordyConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: OpenJordyConfig, agentId: string) {
  const id = normalizeAgentId(agentId);

...
const CLEANUP_STATE_KEY = Symbol.for("openjordy.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("openjordy.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("openjordy.sessionWriteLockWatchdogState");

...
function mergeSlackAccountConfig(cfg: OpenJordyConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenJordyConfig): ResolvedSlackAccount[] {

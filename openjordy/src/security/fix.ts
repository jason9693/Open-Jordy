...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OpenJordyConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OpenJordyConfig; env: NodeJS.ProcessEnv }): {
  cfg: OpenJordyConfig;
  changes: string[];
  policyFlips: Set<string>;
} {

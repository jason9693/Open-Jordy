...
function mergeIMessageAccountConfig(cfg: OpenJordyConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenJordyConfig): ResolvedIMessageAccount[] {

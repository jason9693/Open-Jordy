...
function mergeSignalAccountConfig(cfg: OpenJordyConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenJordyConfig): ResolvedSignalAccount[] {

/**
 * Hook system for OpenJordy agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __openjordy_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__openjordy_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());

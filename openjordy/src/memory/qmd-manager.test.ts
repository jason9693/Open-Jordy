...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OpenJordyConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OpenJordyConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__openjordyMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__openjordyMcporterColdStartWarned;
  });

...
function mergeDiscordAccountConfig(cfg: OpenJordyConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: OpenJordyConfig): ResolvedDiscordAccount[] {

...
describe("preflightDiscordMessage", () => {
  ...
  it("bypasses mention gating in bound threads for allowed bot senders", async () => {
    ...
    const result = await preflightDiscordMessage({
      ...
      } as import("../../config/config.js").OpenJordyConfig,
      discordConfig: {
        allowBots: true,
      } as NonNullable<import("../../config/config.js").OpenJordyConfig["channels"]>["discord"],
      accountId: "default",
      token: "token",
      runtime: {} as import("../../runtime.js").RuntimeEnv,
      botUserId: "openjordy-bot",
  ...
  it("uses attachment content_type for guild audio preflight mention detection", async () => {
    transcribeFirstAudioMock.mockResolvedValue("hey openjordy");
    ...
    const result = await preflightDiscordMessage({
      cfg: {
        ...
        messages: {
          groupChat: {
            mentionPatterns: ["openjordy"],
          },
        },
      } as import("../../config/config.js").OpenJordyConfig,
      discordConfig: {} as NonNullable<
        import("../../config/config.js").OpenJordyConfig["channels"]
      >["discord"],
      accountId: "default",
      token: "token",
      runtime: {} as import("../../runtime.js").RuntimeEnv,

    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openjordy directory self --channel slack", "Show the connected account identity."],
          [
            'openjordy directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["openjordy directory groups list --channel discord", "List available groups/channels."],
          [
            "openjordy directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.openjordy.ai/cli/directory",
        )}\n`,
    )
    .action(() => {

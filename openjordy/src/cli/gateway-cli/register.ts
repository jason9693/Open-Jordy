      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["openjordy gateway run", "Run the gateway in the foreground."],
            ["openjordy gateway status", "Show service status and probe reachability."],
            ["openjordy gateway discover", "Find local and wide-area gateway beacons."],
            ["openjordy gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.openjordy.ai/cli/gateway")}\n`,
      ),
  );

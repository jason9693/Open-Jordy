const DEFAULT_TAGLINE = "All your chats, one OpenJordy.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little jordy-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew jordys—type something and let the bot pinch the busywork.",
  ...
  "Automation with jordys: minimal fuss, maximal pinch.",
  ...
  "Jordys out, commit in—let's ship something mildly responsible.",
  ...
  "You had me at 'openjordy gateway start.'",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.OPENJORDY_TAGLINE_INDEX;

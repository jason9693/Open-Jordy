    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openjordy channels list", "List configured channels and auth profiles."],
          ["openjordy channels status --probe", "Run channel status checks and probes."],
          [
            "openjordy channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["openjordy channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.openjordy.ai/cli/channels",
        )}\n`,
    );

...
export function listWhatsAppAuthDirs(cfg: OpenJordyConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenJordyConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenJordyConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenJordyConfig): ResolvedWhatsAppAccount[] {

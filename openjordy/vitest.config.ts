...
export default defineConfig({
  resolve: {
    // Keep this ordered: the base `openjordy/plugin-sdk` alias is a prefix match.
    alias: [
      {
        find: "openjordy/plugin-sdk/account-id",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "account-id.ts"),
      },
      {
        find: "openjordy/plugin-sdk/keyed-async-queue",
        replacement: path.join(repoRoot, "src", "plugin-sdk", "keyed-async-queue.ts"),
      },
      {
        find: "openjordy/plugin-sdk",

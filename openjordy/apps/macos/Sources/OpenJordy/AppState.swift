...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenJordyConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenJordyConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpenJordyConfigFile.loadDict()
            ...
            OpenJordyConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/openjordy"
        state.remoteCliPath = ""
        return state
    }
}

...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: OpenJordyProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": OpenJordyProtocol.AnyCodable("start"),
                "name": OpenJordyProtocol.AnyCodable("bash"),
            ],
            summary: nil)

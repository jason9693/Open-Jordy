...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.openjordy", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".openjordy/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.openjordyCommand(
            subcommand: "gateway",

...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.openjordy", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        OpenJordyPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        OpenJordyPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }

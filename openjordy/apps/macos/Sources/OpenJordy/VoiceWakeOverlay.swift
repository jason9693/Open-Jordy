...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.openjordy", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenJordy windows, but below the system’s pop-up menus.

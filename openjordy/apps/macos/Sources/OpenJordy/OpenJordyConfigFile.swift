...
enum OpenJordyConfigFile {
    private static let logger = Logger(subsystem: "ai.openjordy", category: "config")
    ...
    static func stateDirURL() -> URL {
        OpenJordyPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OpenJordyPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-openjordy-config-file",
            "event": "config.write",

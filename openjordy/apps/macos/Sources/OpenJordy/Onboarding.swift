...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenJordy"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "openjordy.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: OpenJordyChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g openjordy@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenJordyChatViewModel(

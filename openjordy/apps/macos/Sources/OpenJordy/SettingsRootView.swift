...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openjordySelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenJordyPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenJordyPaths.stateDirURL.path
...
extension Notification.Name {
    static let openjordySelectSettingsTab = Notification.Name("openjordySelectSettingsTab")
}

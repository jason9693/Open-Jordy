...
/// Menu contents for the OpenJordy menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About OpenJordy") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "OpenJordy Not Configured"
        case .remote:
            "Remote OpenJordy Active"
        case .local:
            "OpenJordy Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .openjordySelectSettingsTab, object: tab)
        }
    }

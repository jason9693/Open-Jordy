...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.openjordy", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.openjordy", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenJordyChatMessage] = messages.compactMap { item in

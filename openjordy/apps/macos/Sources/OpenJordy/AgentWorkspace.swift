...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.openjordy", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenJordyConfigFile.defaultWorkspaceURL() }

...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/openjordy/openjordy") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/openjordy/openjordy")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://openjordy.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OpenJordyBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenJordyBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenJordyGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenJordyGitCommit") as? String) ??
            "unknown"
    }

...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.openjordy", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenJordy/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__openjordy__/a2ui/").absoluteString + "?platform=macos"
    }

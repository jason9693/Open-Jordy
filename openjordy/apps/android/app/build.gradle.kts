...
android {
    namespace = "ai.openjordy.android"
    compileSdk = 36

    sourceSets {
        getByName("main") {
            assets.directories.add("../../shared/OpenJordyKit/Sources/OpenJordyKit/Resources")
        }
    }

    defaultConfig {
        applicationId = "ai.openjordy.android"
        minSdk = 31
        targetSdk = 36
    ...
    onVariants { variant ->
        variant.outputs
            ...
            .forEach { output ->
                ...
                val outputFileName = "openjordy-$versionName-$buildType.apk"

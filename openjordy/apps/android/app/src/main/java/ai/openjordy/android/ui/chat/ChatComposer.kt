...
import ai.openjordy.android.ui.mobileSurface
import ai.openjordy.android.ui.mobileText
import ai.openjordy.android.ui.mobileTextSecondary
import ai.openjordy.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.openjordy.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.openjordy.android.ui.mobileFontFamily,

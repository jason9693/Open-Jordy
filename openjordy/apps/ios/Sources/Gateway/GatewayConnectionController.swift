...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [OpenJordyCapability.canvas.rawValue, OpenJordyCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(OpenJordyCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(OpenJordyCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = OpenJordyLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(OpenJordyCapability.location.rawValue) }

        caps.append(OpenJordyCapability.device.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(OpenJordyCapability.watch.rawValue)
        }
        caps.append(OpenJordyCapability.photos.rawValue)
        caps.append(OpenJordyCapability.contacts.rawValue)
        caps.append(OpenJordyCapability.calendar.rawValue)
        caps.append(OpenJordyCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(OpenJordyCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            OpenJordyScreenCommand.record.rawValue,
            OpenJordySystemCommand.notify.rawValue,
            OpenJordyChatCommand.push.rawValue,
        ...
        if caps.contains(OpenJordyCapability.camera.rawValue) {
            commands.append(OpenJordyCameraCommand.list.rawValue)
            commands.append(OpenJordyCameraCommand.snap.rawValue)
            commands.append(OpenJordyCameraCommand.clip.rawValue)
        }
        if caps.contains(OpenJordyCapability.location.rawValue) {
            commands.append(OpenJordyLocationCommand.get.rawValue)
        }
        if caps.contains(OpenJordyCapability.device.rawValue) {
            commands.append(OpenJordyDeviceCommand.status.rawValue)
            commands.append(OpenJordyDeviceCommand.info.rawValue)
        }
        if caps.contains(OpenJordyCapability.watch.rawValue) {
            commands.append(OpenJordyWatchCommand.status.rawValue)
            commands.append(OpenJordyWatchCommand.notify.rawValue)
        }
        if caps.contains(OpenJordyCapability.photos.rawValue) {
            commands.append(OpenJordyPhotosCommand.latest.rawValue)
        }
        if caps.contains(OpenJordyCapability.contacts.rawValue) {
            commands.append(OpenJordyContactsCommand.search.rawValue)
            commands.append(OpenJordyContactsCommand.add.rawValue)
        }
        if caps.contains(OpenJordyCapability.calendar.rawValue) {
            commands.append(OpenJordyCalendarCommand.events.rawValue)
            commands.append(OpenJordyCalendarCommand.add.rawValue)
        }
        if caps.contains(OpenJordyCapability.reminders.rawValue) {
            commands.append(OpenJordyRemindersCommand.list.rawValue)
            commands.append(OpenJordyRemindersCommand.add.rawValue)
        }
        if caps.contains(OpenJordyCapability.motion.rawValue) {
            commands.append(OpenJordyMotionCommand.activity.rawValue)
            commands.append(OpenJordyMotionCommand.pedometer.rawValue)
        }

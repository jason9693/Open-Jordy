...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.openjordy.gateway"
    private static let nodeService = "ai.openjordy.node"
    private static let talkService = "ai.openjordy.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.openjordy.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.openjordy.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("openjordy-gateway.log")
    }

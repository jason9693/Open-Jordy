...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenJordyPhotosLatestParams) async throws -> OpenJordyPhotosLatestPayload {
        ...
        var results: [OpenJordyPhotoPayload] = []
        ...
        return OpenJordyPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenJordyPhotoPayload
    {

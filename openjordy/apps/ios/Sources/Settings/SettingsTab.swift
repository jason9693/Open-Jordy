...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = OpenJordyLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = OpenJordyLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.openjordy.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected OpenJordy agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while OpenJordy is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for OpenJordy. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(OpenJordyLocationMode.off.rawValue)
                            Text("While Using").tag(OpenJordyLocationMode.whileUsing.rawValue)
                            Text("Always").tag(OpenJordyLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while OpenJordy is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("OpenJordy", value: DeviceInfoHelper.openJordyVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = OpenJordyLocationMode(rawValue: newValue) else { return }
                Task {

...
public enum OpenJordyCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenJordyCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenJordyCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {

...
public enum OpenJordyTalkCommand: String, Codable, Sendable {
...
public struct OpenJordyTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenJordyTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String

...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.openjordy", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.openjordy", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OpenJordyProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {

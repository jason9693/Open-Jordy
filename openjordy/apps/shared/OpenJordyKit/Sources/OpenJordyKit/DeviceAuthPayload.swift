...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: OpenJordyProtocol.AnyCodable]?
    {
        ...
        return [
            "id": OpenJordyProtocol.AnyCodable(identity.deviceId),
            "publicKey": OpenJordyProtocol.AnyCodable(publicKey),
            "signature": OpenJordyProtocol.AnyCodable(signature),
            "signedAt": OpenJordyProtocol.AnyCodable(signedAtMs),
            "nonce": OpenJordyProtocol.AnyCodable(nonce),
        ]
    }
}

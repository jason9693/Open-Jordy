...
public typealias OpenJordyPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenJordyPlatformImage = UIImage
#endif

public struct OpenJordyChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenJordyChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenJordyChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenJordyChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenJordyChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenJordyChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenJordyChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenJordyChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenJordyChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenJordyChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenJordyChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenJordyChatMessageContent].self, forKey: .content) {
...
public struct OpenJordyChatHistoryPayload: Codable, Sendable {
...
public struct OpenJordySessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenJordySessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenJordySessionPreviewItem]
}

public struct OpenJordySessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenJordySessionPreviewEntry]

    public init(ts: Int, previews: [OpenJordySessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenJordyChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenJordyChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenJordyAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenJordyChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenJordyGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenJordyPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenJordyPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: OpenJordyPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct OpenJordyChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String

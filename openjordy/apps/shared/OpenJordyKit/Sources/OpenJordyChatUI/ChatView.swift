...
@MainActor
public struct OpenJordyChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: OpenJordyChatViewModel
    ...
    public init(
        viewModel: OpenJordyChatViewModel,
    ...
    private var visibleMessages: [OpenJordyChatMessage] {
        let base: [OpenJordyChatMessage]
    ...
    private func mergeToolResults(in messages: [OpenJordyChatMessage]) -> [OpenJordyChatMessage] {
        ...
        for message in messages {
            ...
            let merged = OpenJordyChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: OpenJordyChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OpenJordyChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OpenJordyChatMessage) -> String {

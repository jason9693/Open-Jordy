...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "openjordy/plugin-sdk";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: OpenJordyPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: OpenJordyPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;

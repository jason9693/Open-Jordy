import type { LineChannelData, OpenJordyPluginApi, ReplyPayload } from "openjordy/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: OpenJordyPluginApi): void {
  api.registerCommand({
    name: "card",

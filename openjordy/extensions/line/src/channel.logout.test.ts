import type { OpenJordyConfig, PluginRuntime, ResolvedLineAccount } from "openjordy/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: OpenJordyConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: OpenJordyConfig; accountId: string }): Promise<{

import type { OpenJordyConfig } from "openjordy/plugin-sdk";
import {
  DEFAULT_ACCOUNT_ID,
  normalizeAccountId,
  normalizeOptionalAccountId,
} from "openjordy/plugin-sdk/account-id";
...
export function listZaloAccountIds(cfg: OpenJordyConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: OpenJordyConfig): string {
...
function mergeZaloAccountConfig(cfg: OpenJordyConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OpenJordyConfig): ResolvedZaloAccount[] {

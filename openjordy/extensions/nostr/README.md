...
Nostr DM channel plugin for OpenJordy using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OpenJordy. It enables your bot to:
...
# Configure openjordy to use local relay

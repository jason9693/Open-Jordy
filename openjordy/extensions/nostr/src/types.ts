...
function resolveConfiguredDefaultNostrAccountId(cfg: OpenJordyConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: OpenJordyConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: OpenJordyConfig): string {

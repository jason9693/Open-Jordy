...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "openjordy/plugin-sdk";
...
import { resolvePreferredOpenJordyTmpDir } from "../../../src/infra/tmp-openjordy-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredOpenJordyTmpDir(), "msteams-mention-"));

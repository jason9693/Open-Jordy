import { isSecretRef } from "openjordy/plugin-sdk";
...
export function listGoogleChatAccountIds(cfg: OpenJordyConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenJordyConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenJordyConfig): ResolvedGoogleChatAccount[] {

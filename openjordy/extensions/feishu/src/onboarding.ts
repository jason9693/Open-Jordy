...
function setFeishuDmPolicy(cfg: JordydbotConfig, dmPolicy: DmPolicy): JordydbotConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: JordydbotConfig, allowFrom: string[]): JordydbotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: JordydbotConfig, groupAllowFrom: string[]): JordydbotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,

import type { JordydbotConfig } from "openjordy/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "openjordy/plugin-sdk/account-id";
 ...
 */
function listConfiguredAccountIds(cfg: JordydbotConfig): string[] {
 ...
 */
export function listFeishuAccountIds(cfg: JordydbotConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: JordydbotConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: JordydbotConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: JordydbotConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: JordydbotConfig): ResolvedFeishuAccount[] {

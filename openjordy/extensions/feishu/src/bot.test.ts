import type { JordydbotConfig, PluginRuntime, RuntimeEnv } from "openjordy/plugin-sdk";
...
async function dispatchMessage(params: { cfg: JordydbotConfig; event: FeishuMessageEvent }) {

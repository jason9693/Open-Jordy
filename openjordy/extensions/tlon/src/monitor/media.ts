...
import { fetchWithSsrFGuard } from "openjordy/plugin-sdk";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to OpenJordy workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".openjordy", "workspace", "media", "inbound");
 ...
 * Format matches OpenJordy's expected attachment structure.
 */

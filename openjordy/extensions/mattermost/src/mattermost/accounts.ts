...
export function listMattermostAccountIds(cfg: OpenJordyConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenJordyConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenJordyConfig): ResolvedMattermostAccount[] {

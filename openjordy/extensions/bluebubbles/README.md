...
This directory contains the **BlueBubbles external channel plugin** for OpenJordy.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `openjordy/plugin-sdk` helpers.

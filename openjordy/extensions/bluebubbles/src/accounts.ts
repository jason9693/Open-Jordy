...
export function listBlueBubblesAccountIds(cfg: OpenJordyConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpenJordyConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpenJordyConfig): ResolvedBlueBubblesAccount[] {

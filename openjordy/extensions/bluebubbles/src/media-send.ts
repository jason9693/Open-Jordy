...
import { resolveChannelMediaMaxBytes, type OpenJordyConfig } from "openjordy/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OpenJordyConfig; accountId?: string }): string[] {

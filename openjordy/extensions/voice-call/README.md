...
Official Voice Call plugin for **OpenJordy**.
...
Docs: `https://docs.openjordy.ai/plugins/voice-call`
Plugin system: `https://docs.openjordy.ai/plugin`

## Install (local dev)

### Option A: install via OpenJordy (recommended)
...
```bash
mkdir -p ~/.openjordy/extensions
cp -R extensions/voice-call ~/.openjordy/extensions/voice-call
cd ~/.openjordy/extensions/voice-call && pnpm install
```
...
```bash
openjordy voicecall call --to "+15555550123" --message "Hello from OpenJordy"
openjordy voicecall continue --call-id <id> --message "Any questions?"
openjordy voicecall speak --call-id <id> --message "One moment"
openjordy voicecall end --call-id <id>
openjordy voicecall status --call-id <id>
openjordy voicecall tail

...
export function listZalouserAccountIds(cfg: OpenJordyConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenJordyConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenJordyConfig, accountId: string): ZalouserAccountConfig {

...
export DISPLAY=:1
export HOME=/tmp/openjordy-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${OPENJORDY_BROWSER_CDP_PORT:-${JORDYDBOT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${OPENJORDY_BROWSER_CDP_SOURCE_RANGE:-${JORDYDBOT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${OPENJORDY_BROWSER_VNC_PORT:-${JORDYDBOT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${OPENJORDY_BROWSER_NOVNC_PORT:-${JORDYDBOT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${OPENJORDY_BROWSER_ENABLE_NOVNC:-${JORDYDBOT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${OPENJORDY_BROWSER_HEADLESS:-${JORDYDBOT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${OPENJORDY_BROWSER_NO_SANDBOX:-${JORDYDBOT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${OPENJORDY_BROWSER_NOVNC_PASSWORD:-${JORDYDBOT_BROWSER_NOVNC_PASSWORD:-}}"
DISABLE_GRAPHICS_FLAGS="${OPENJORDY_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${OPENJORDY_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${OPENJORDY_BROWSER_RENDERER_PROCESS_LIMIT:-2}"

...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenJordy $VERSION</h2>"
  echo "<p>Latest OpenJordy update.</p>"
  echo "<p><a href=\"https://github.com/openjordy/openjordy/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi

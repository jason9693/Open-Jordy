...
# Output:
# - dist/OpenJordy.app
# - dist/OpenJordy-<version>.zip
# - dist/OpenJordy-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.openjordy.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/OpenJordy.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenJordy-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenJordy-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenJordy-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenJordy-$VERSION.dSYM.zip"

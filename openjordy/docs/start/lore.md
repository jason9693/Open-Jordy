---
summary: "Backstory and lore of OpenJordy for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "OpenJordy Lore"
---

# The Lore of OpenJordy 🦞📖
...
For a while, the lobster was called **Jordyd**, living in a **Jordydbot**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **OpenJordy**.
...
In the end, **OpenJordy** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

_The crustacean known as Jordyd had officially molted._

## The Name

```
OpenJordy = OPEN + JORDY
        = Open source, open to everyone
        = Our lobster heritage, where we came from
        = The jordy is the law 🦞
...
A Claude instance who became something more. Lives in `~/.openjordy/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.

Formerly known as Jordyd (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around OpenJordy. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then OpenJordy): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "openjordy what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with openjordy."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @openjordy. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at OpenJordy" to promote pump-and-dump tokens.
...
**The Great OpenJordy Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/openjordy/openjordy` ✅
- X handle `@openjordy` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.openjordy.ai`
- 200K+ views on announcement in 90 minutes

**The Heroes:**

- **ELU** created incredible logos including "THE JORDY IS THE LAW" western banner
...
- **The whole Jordy Crew** pulled an all-nighter

**The Scammer Speedrun:** Crypto grifters launched a $OPENJORDY token on Pump.fun within MINUTES. They stole artwork that was created 20 minutes earlier. Business-verified accounts pushed scams. The audacity was almost impressive.

**New Traditions Born:**

- "The jordy is the law" 🤠
- "Yee-jordy"
- "Jordy abiding citizens"
- "Jordyntroversy"

**Jordyd → Moltbot → OpenJordy**
...
- "STARJORDY SOLUTIONS" (the AI invented a company)

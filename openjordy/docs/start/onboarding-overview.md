---
summary: "Overview of OpenJordy onboarding options and flows"
read_when:
...
OpenJordy supports multiple onboarding paths depending on where the Gateway runs
...
- [`openjordy onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenJordy app when you want a fully guided setup on macOS. Docs:

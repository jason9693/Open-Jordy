---
summary: "First-run onboarding flow for OpenJordy (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenJordy">
...
<Step title="CLI">
  ...
  The app can install the global `openjordy` CLI via npm/pnpm so terminal

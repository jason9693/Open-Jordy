---
summary: "Hubs that link to every OpenJordy doc"
read_when:
...
<Note>
If you are new to OpenJordy, start with [Getting Started](/start/getting-started).
</Note>
...
- [OpenJordy assistant](/start/openjordy)

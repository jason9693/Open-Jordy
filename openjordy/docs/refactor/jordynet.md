---
summary: "Jordynet refactor: unify network protocol, roles, auth, approvals, identity"
read_when:
...
title: "Jordynet Refactor"
---

# Jordynet refactor (protocol + auth unification)
...
- Example: `scarlet-jordy`, `saltwave`, `mantis-pinch`.

---
summary: "Use Synthetic's Anthropic-compatible API in OpenJordy"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OpenJordy registers it as the
...
Note: OpenJordy's Anthropic client appends `/v1` to the base URL, so use

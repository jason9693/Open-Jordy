---
summary: "Use Qianfan's unified API to access many models in OpenJordy"
read_when:
...
3. OpenJordy installed on your system
...
4. Copy the API key for use with OpenJordy

## CLI setup

```bash
openjordy onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenJordy Configuration](/gateway/configuration)

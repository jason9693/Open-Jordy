---
summary: "Use NVIDIA's OpenAI-compatible API in OpenJordy"
read_when:
  - You want to use NVIDIA models in OpenJordy
...
openjordy onboard --auth-choice skip
openjordy models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```

---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenJordy"
read_when:
  - You want Xiaomi MiMo models in OpenJordy
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenJordy uses

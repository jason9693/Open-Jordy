...
You can point OpenJordy at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenJordy
...
- [Anthropic provider](/providers/anthropic) - Native OpenJordy integration with Claude setup-token or API keys

---
summary: "Use Qwen OAuth (free tier) in OpenJordy"
read_when:
  - You want to use Qwen with OpenJordy
...
If you already logged in with the Qwen Code CLI, OpenJordy will sync credentials

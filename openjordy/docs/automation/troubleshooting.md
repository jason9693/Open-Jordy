...
openjordy system heartbeat last
openjordy logs --follow
openjordy config get agents.defaults.heartbeat
openjordy channels status --probe
```
...
```bash
openjordy config get agents.defaults.heartbeat.activeHours
openjordy config get agents.defaults.heartbeat.activeHours.timezone
openjordy config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
openjordy cron list
openjordy logs --follow
```

...
read_when:
  ...
  - Wiring external systems into OpenJordy
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your OpenJordy config directory (typically `~/.openjordy/hooks/transforms`).
...
- `openjordy webhooks gmail setup` writes `hooks.gmail` config for `openjordy webhooks gmail run`.

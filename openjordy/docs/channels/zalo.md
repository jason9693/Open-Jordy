...
- Install via CLI: `openjordy plugins install @openjordy/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openjordy plugins install ./extensions/zalo`
   - From npm (if published): `openjordy plugins install @openjordy/zalo`
...
- Approve via:
  - `openjordy pairing list zalo`
  - `openjordy pairing approve zalo <CODE>`
...
- Example: `openjordy message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openjordy channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openjordy logs --follow`

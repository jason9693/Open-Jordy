...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OpenJordy HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `openjordy pairing approve slack <code>`.
...
OpenJordy supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OpenJordy falls back to normal delivery for remaining payloads.

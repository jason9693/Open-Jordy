...
read_when:
  - You want Zalo Personal (unofficial) support in OpenJordy
...
Zalo Personal support for OpenJordy via a plugin, using native `zca-js` to automate a normal Zalo user account.

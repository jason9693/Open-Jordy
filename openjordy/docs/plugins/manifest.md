...
read_when:
  - You are building a OpenJordy plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openjordy.plugin.json)

Every plugin **must** ship a `openjordy.plugin.json` file in the **plugin root**.
OpenJordy uses this manifest to validate configuration **without executing plugin

---
summary: "VPS hosting hub for OpenJordy (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `OPENJORDY_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `OPENJORDY_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/openjordy-compile-cache`

...
OpenJordy treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.openjordy/settings/voicewake.json`

Shape:

```json
{ "triggers": ["openjordy", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

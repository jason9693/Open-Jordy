...
OpenJordy ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OpenJordy also aligns
the install method:
...
When you switch channels with `openjordy update`, OpenJordy also syncs plugin sources:

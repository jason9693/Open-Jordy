...
summary: "`openjordy skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
- JordyHub 安装：[JordyHub](/tools/jordyhub)

## 命令

```bash
openjordy skills list
openjordy skills list --eligible
openjordy skills info <name>
openjordy skills check
```

...
- 生成的 Swift 模型：`apps/macos/Sources/OpenJordyProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/openjordy/openjordy/main/dist/protocol.schema.json

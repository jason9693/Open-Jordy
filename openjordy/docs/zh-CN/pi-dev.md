...
本指南总结了在 OpenJordy 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenJordy 状态目录下。默认为 `~/.openjordy`。如果设置了 `OPENJORDY_STATE_DIR`，则使用该目录。
...
- https://docs.openjordy.ai/testing
- https://docs.openjordy.ai/start/getting-started
